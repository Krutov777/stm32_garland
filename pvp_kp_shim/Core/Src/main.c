...
int main(void)
{
  ...
  while (1)
  {
    ...
    TIM1->CCER &= ~TIM_CCER_CC1NP;
		for(i=0;i<=count/16*7;i++)
		{
			if(i<count/16) 
			{
				TIM1->CCR1 = 65535 * (i / (count/16));
			}
      else if(i == count/16) 
      {
        TIM1->CCER &= ~TIM_CCER_CC1NP;
        ...
        TIM1->CCER |= TIM_CCER_CC2NE;
			...
			{
				TIM1->CCR1 = 65535 * ((count/16*2-i)/(count/16));
				TIM1->CCR2 = 65535 * ((count/16*2-i)/(count/16));
			}
      else if(i == count/16*2)
      {
        TIM1->CCR1 = 0;
        TIM1->CCER &= ~TIM_CCER_CC2NP;
        TIM1->CCER |= TIM_CCER_CC2E;
			...
			{
        TIM1->CCR2 = 65535 * ((i-count/16*2)/(count/16));
			}
      else if(i == count/16*3)
      {
				TIM1->CCER &= ~TIM_CCER_CC2NP;
				TIM1->CCER |= TIM_CCER_CC2E;
				TIM1->CCER &= ~TIM_CCER_CC2NE;
			...
			{ 
				TIM1->CCR2 = 65535 * ((count/16*4-i)/(count/16));
				TIM1->CCR3 = 65535 * ((count/16*4-i)/(count/16));
			}
      else if(i == count/16*4)
      {
				TIM1->CCR2 = 0;
				TIM1->CCER &= ~TIM_CCER_CC3NP;
				TIM1->CCER |= TIM_CCER_CC3E;
			...
			{
				TIM1->CCR3 = 65535 * ((i-count/16*4)/(count/16));
			}
      else if(i == count/16*5)
      {
				TIM1->CCER &= ~TIM_CCER_CC3NP;
				TIM1->CCER |= TIM_CCER_CC3E;
				TIM1->CCER &= ~TIM_CCER_CC3NE;
			...
			{
				TIM1->CCR3 = 65535 * ((count/16*6-i)/(count/16));
				TIM1->CCR4 = 65535 * ((count/16*6-i)/(count/16));
			}
      else if(i == count/16*6)
      {
				TIM1->CCR3 = 0;
				TIM1->CCER |= TIM_CCER_CC1NE;
			...
			{
				TIM1->CCR4 = 65535 * ((i-count/16*6)/(count/16));
				TIM1->CCR1 = 65535 * ((i-count/16*6)/(count/16));
			}
      else if(i == count/16*7)
      {
				TIM1->CCR4 = 65535;
